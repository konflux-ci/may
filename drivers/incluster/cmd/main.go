...
import (
	...
	"github.com/konflux-ci/may/drivers/incluster/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "fa308d5a.may.konflux-ci.dev",
		Cache: cache.Options{
			ByObject: map[client.Object]cache.ByObject{
				&maykonfluxcidevv1alpha1.StaticHost{}: {
					Label: labels.SelectorFromSet(labels.Set{"may.konflux-ci.dev/driver": "incluster"}),
				},
