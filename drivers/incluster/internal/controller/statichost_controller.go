...
const (
	KeySize                  int    = 4096
	InClusterDriverFinalizer string = "drivers.may.konflux-ci.dev/incluster"
)
...
func (r *StaticHostReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	case maykonfluxcidevv1alpha1.HostStatusDrained:
		panic("to be implemented")
		// case mayprovkonfluxcidevv1alpha1.HostStatusHalted:
		// 	panic("to be implemented")
	}
...
func (r *StaticHostReconciler) ensurePending(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) (ctrl.Result, error) {
...
func (r *StaticHostReconciler) ensureReady(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) (ctrl.Result, error) {
...
func (r *StaticHostReconciler) ensureResourcesExists(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) error {
	l := logf.FromContext(ctx)
...
func (r *StaticHostReconciler) ensureKeySecretExists(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) error {
	s := corev1.Secret{
...
func (r *StaticHostReconciler) generatePEMKey(ctx context.Context) ([]byte, []byte, error) {
	l := logf.FromContext(ctx)
...
func (r *StaticHostReconciler) ensurePodExists(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) error {
	p := corev1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			Name:      h.Name,
			Namespace: h.Namespace,
	...
	if err := r.Get(ctx, client.ObjectKeyFromObject(&p), &p); err != nil {
		if kerrors.IsNotFound(err) {
			p.Labels = map[string]string{
				...
				"may.konflux-ci.dev/runner-type": "static",
			}
...
func (r *StaticHostReconciler) ensureServiceExists(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) error {
	p := corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			Name:      h.Name,
			Namespace: h.Namespace,
...
func (r *StaticHostReconciler) finalize(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) (ctrl.Result, error) {
...
func (r *StaticHostReconciler) ensurePodDoesNotExist(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) error {
	p := corev1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			Name:      h.Name,
			Namespace: h.Namespace,
...
func (r *StaticHostReconciler) ensureSecretDoesNotExist(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) error {
	s := corev1.Secret{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "ssh-" + h.Name + "-key",
			Namespace: h.Namespace,
...
func (r *StaticHostReconciler) ensureServiceDoesNotExist(ctx context.Context, h *maykonfluxcidevv1alpha1.StaticHost) error {
	s := corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			Name:      h.Name,
			Namespace: h.Namespace,
...
func (r *StaticHostReconciler) deleteResource(ctx context.Context, obj client.Object) error {
