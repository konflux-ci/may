...
| Operator deletes Ready DynamicHost with 1 Runner | When an operator manually deletes a Ready DynamicHost that has one Runner, May's finalizer deletes the Runner and then the DynamicHost is removed; see `dynamichost_test.go` |
