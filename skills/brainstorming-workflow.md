...
description: >
  ...
  change, refactor, or architectural decision in MAY. Provides a structured
...
MAY examples where this helps:
- Introducing a new Driver
- Introducing different strategies to orchestrate VMs
